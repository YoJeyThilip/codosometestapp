	...
	*/
    ...
    {	
		...
		if( isset( $_POST['insert_table'] ) && $_POST['insert_table'] == 'common_items' ){
			...
			DB::table('common_items')->insert(  ['brand' =>  $_POST['brand'], 'product' =>  $_POST['product'] , 'cost' =>  $_POST['cost'], 'non_online_store' =>  $_POST['non_online_store'], 'online_store' =>  $_POST['online_store']  ] );
			
		}else if(  isset( $_POST['insert_table'] ) && $_POST['insert_table'] == 'commission_rates'  ) { 
		
			DB::table('commission_rates')->insert([ 'shirts' =>  $_POST['shirts'], 'rate' =>  $_POST['rate'] ]);
			
		}else if( isset( $_POST['insert_table'] ) && $_POST['insert_table'] == 'addons'  ) { 
		
			DB::table('addons')->insert([ 'add_on' =>  $_POST['add_on'], 'prize' =>  $_POST['prize'] ]);
