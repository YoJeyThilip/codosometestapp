...
{ 
	...
	*/
    ...
    {	
		...
		// data insert --> start
		if( isset( $_POST ) && $_POST['insert_table'] == 'common_items' ){
		...
		}else if(  isset( $_POST ) && $_POST['insert_table'] == 'commission_rates'  ) { 
		
			DB::table('commission_rates')->insert(['id' => $_POST['id'] , 'shirts' =>  $_POST['shirts'], 'rate' =>  $_POST['rate'] ]);
			
		}else if( isset( $_POST ) && $_POST['insert_table'] == 'addons'  ) { 
		
			DB::table('addons')->insert(['id' => $_POST['id'] , 'add_on' =>  $_POST['add_on'], 'prize' =>  $_POST['prize'] ]);
			
		}else if( isset( $_POST ) && $_POST['insert_table'] == 'calculator_fabric' ) { 
