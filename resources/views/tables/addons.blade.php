...
$(document).ready(function() {
	...
	// custom toolbar
	//$("div.dt-toolbar .create-button-colors-style").html('<form action="{{ route("tables") }}?insert=common_items" method="post">@csrf<input type="hidden" name="insert_page" value="common_items"><input type="submit" class="insert_form" value="Insert"></form>'); 
});
</script>
