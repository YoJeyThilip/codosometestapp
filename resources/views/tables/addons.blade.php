...
$(document).ready(function() {
	...
	// custom toolbar
	$("div.dt-toolbar .create-button-colors-style").html('<form action="{{ route("tables") }}?insert=common_items" method="post"><input type="hidden" name="insert_table" value="common_items"><input type="submit" name="submit" value="Insert"></form>'); 
});
</script>
