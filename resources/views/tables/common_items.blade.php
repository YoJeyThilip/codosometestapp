...
$(document).ready(function() {
	...
	$('#dt_basic').dataTable({
				...
				// custom toolbar
				$("div.dt-toolbar .create-button-colors-style").html('<form action="{{ route("tables") }}?insert=common_items" method="post">@csrf<input type="hidden" name="insert_page" value="common_items"><input class="insert_form" type="submit" value="Create New"></form>');
