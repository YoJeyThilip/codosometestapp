...
$(document).ready(function() {
	...
	$('#dt_basic').dataTable({
				...
				// custom toolbar
				$("div.dt-toolbar .create-button-colors-style").html('<form action="" method="post">@csrf<input type="hidden" name="insert_page" value="common_items"><input class="insert_form" type="submit" value="Insert"></form>');
